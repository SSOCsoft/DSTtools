...
FOR i = 0,(N_ELEMENTS(files)-2) DO BEGIN &$
   ...
   ;;OPENW,out_lun,/GET_LUN,save_directory+'kisip.raw.batch' +
   ;;batchname + '.' + STRING(counter,FORMAT='(I3.3)') &$ ;SJS 3/13/2018
	OPENW,out_lun,/GET_LUN,'pre_speckle/'+'kisip.raw.batch' + batchname + '.' + STRING(counter,FORMAT='(I3.3)') &$
...
;;Creates files, init_file.dat, init_props.dat, init_method.dat
...
;       U IN X: 10
;       U, V & U+V: 10
;       MAXIMUM ITERATIONS: 60 ;30
;       AUTOSET THRESHOLD: 95 ;80
;       WEIGHTING EXPONENT: 1.2
;       PHASE APODISATION: 15 ;30
...
FOR i = 0,(N_ELEMENTS(files_kisip)-1) DO BEGIN &$
    image = LOAD_SPECKLE_IM(files_kisip[i],image_size)>0. &$ ;Originally imsize=image_size
...
test_files = FILE_SEARCH(final_directory+'*.fits')
