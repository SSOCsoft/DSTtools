...
;host=strlowcase('HOST') & sdir=getenv('SPECTRAL_DATA')
...
;filename = '/net/cbeck-pc1/export/cbeck/work/extern_idl/fts_cent.dat'

skip=fix(wl-3290)
;cmd='dd if='+sdir+'/fts_cent.dat of='+tdir+ $
 
cmd='dd if='+filename+' of='+tdir+ $
